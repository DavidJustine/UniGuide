...
<head>
    ...
    <title>UNIGUIDE| Prerequisites of Subjects</title>
...
<div class="mainc -with-mobile">
	<div class="label-on-top">
		<h2 id="h2-pre">PREREQUISITES OF SUBJECTS</h2>
	</div>
	<div class="cards">
		<div class="card" data-index="0">
			<div class="card__inner">  
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">The rules on sequence of subjects in the curriculum of the course being taken must be followed.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">A student is not allowed a subject without passing its prerequisite.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
