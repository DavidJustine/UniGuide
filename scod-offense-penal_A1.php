...
<div class="mainc -with-mobile">
	<div class="label-on-top"><h2>ARTICLE I. RULES & REGULATIONS ON STUDENT CONDUCT & DISCIPLINE</h2></div>
	...
	<div class="row">
		<div class=" column column-left">
			<p class="left-align">A student who shall be found to be pregnant shall be advised to take a leave of absence until two months after her childbirth, primarily to save the gestating mother from the stress of school activities for the benefit of the unborn child.</p>
		</div>
		<div class="column column-right">
			<div class="video-container">
