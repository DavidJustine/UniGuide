...
<head>
    ...
    <title>UNIGUIDE| Time Limits for the Completion of Degree Program</title>
    ...
    <link rel="stylesheet" href="css/academic_timelimit.css">
...
<div class="timeline">
    <h2>TIME LIMITS FOR THE COMPLETION OF DEGREE PROGRAM<br><br></h2>
</div>

<h2>Section 1</h2>
    <p><br>Every student is expected to complete his degree within the prescribed period. 
...
<table class="table_time">
  ...
  <tbody>
    <tr>
      <th>MA/MS</th>
      <td>Five (5) school years inclusive of leaves of absence</td>
    </tr>

    <tr>
      <th>Ph.D.</td>
      <td>Seven (7) school years inclusive of leaves of absence</td>
    </tr>

    <tr>
      <th>Certificate Programs</th>
      <td>Two (2) school years inclusive of leaves of absence</td>
    </tr>
  </tbody>  
  ...
  <tbody>
    ...
    <tr>
      <th></th>
      <td>*exclusive of the leave of absence</td>
    </tr>
  </tbody>
...
<h2><br>Section 2</h2>
    <p><br>A student who desires to transfer to another program will 
    be given the chance to finish the new program within the allowable maximum period to stay in the University.<br><br><br><br><br>
    </p>
