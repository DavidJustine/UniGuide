...
<head>
    ...
    <title>UNIGUIDE| Substitution of Subjects</title>
...
<div class="mainc -with-mobile">
    ...
    <h2 id="h2-sub">SUBSTITUTION OF SUBJECTS</h2>
	</div>
	<div class="cards">
		...
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">
					No substitution shall be allowed for a subject in which a student failed. However, this may be allowed when the proposed substitution substantially covers the same subject matter as the required subject.
					</p>
				</div>
			</div>
		</div>
