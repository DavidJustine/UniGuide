...
<head>
    ...
    <title>UNIGUIDE| Validation</title>
		...
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					Only courses taken from any non-deregulated Higher Education Institution (HEI) and CHED-supervised institution with a grade of "85" or lower can be validated. Those taken from deregulated HEIs and SUCS are automatically credited.
					</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Validation shall be undertaken within the first term from the date of admission into the University.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">DOUS. Validation of courses, training activities and seminars may be given credits subject to the evaluation of a committee.</p>
					</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Undergraduate. Courses may be given credit subject to the evaluation of a committee using an institutional policy on validation.</p>
					</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">A validation fee shall be charged.</p>
					</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Validation should be administered and checked by the Instructor assigned by the Program Chair/Institute Director/Dean.</p>
					</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Validation marks are either "Sustained" or "Failed" and should be submitted within the term.</p>
					</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">A degree holder from a State College or University other than DMMMSU may be credited equivalent course without validating them, provided, that such credits shall not exceed 50% of the total number of units required for graduation. The subjects to be credited shall be determined by the Program Chair /Institute Director/Dean concerned.</p>
					</div>
			</div>
		</div>
	</div>
