  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        Only courses taken from any non-deregulated Higher Education Institution (HEI) and CHED-supervised institution with a grade of "85" or lower can be validated. Those taken from deregulated HEIs and SUCS are automatically credited.</p>
      </div>
    </div>
  </div>
...
evaluation of a committee using an institutional policy on validation.
        </p>
        </div>
    </div>
  </div>
