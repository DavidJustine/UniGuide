...
<head>
    ...
    <title>UNIGUIDE| Cross Enrollment</title>
...
<div class="timeline">
    <h2 id="h2-cross">CROSS ENROLLMENT<br><br></h2>
</div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        Cross-enrollment to deregulated private HEls/another SUC/within 
        the University may be allowed for subjects which are not offered 
        in the campus during the time of enrollment, upon approval of the 
        Dean/Institute Director as recommended by the Program Chair and the Registrar.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        <p class="card__description">
        No student is allowed to cross-enroll in two or more HEIs within a term.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        <p class="card__description">
        The University shall give no credit for any subject taken by 
        a student in any other HEI if enrollment in such subject was 
        not authorized in writing by the concerned officials.
        </p>
      </div>
    </div>
  </div>
