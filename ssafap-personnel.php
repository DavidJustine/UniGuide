...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.css" rel="stylesheet"/>
		<style>
		#personnel, #personnel_p { width: auto; }
		#personnel { margin: 0; }
		#personnel_p { font-weight: normal; }
		</style>
</head>
<body>
...
<div class="mainc -with-mobile">
	...
	<h2 id="personnel_p">The Personnel In-Charge of Scholarsip and<br/>Student Assistanships Program reports directly to the<br/>Head/ Director of Student Affairs and Services</h2>
</div>
</body>
</html>
