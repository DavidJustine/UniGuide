  ...
  <body>
    ...
    <div class="mainc -with-mobile">
      <div class="label-on-top">
        <h2>CODE OF CONDUCT AND ETHICAL STANDARDS FOR THE OFFICERS OF THE DMMMSU- SBO, ENUMERATIONG NORMS OF CONDUCT AND DUTIES OF OFFICERS AND MECHANICS AND/OR GUIDELINES FOR RECALL OR IMPEACHMENT, AND FOR OTHER PURPOSES</h2>
      </div>
      <p><i>Be it resolved by the University Student Council of the Don Mariano Marcos Memorial State University assembled:</i></p>
      <h3 class="article">Sec. 1 TITLE.</h3>
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-28">
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 2 DECLARATION OF POLICY.</h3>
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-29">
        <div class="blog-slider__wrp swiper-wrapper">
          <!-- First Slide for the Second Slider -->
          <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__content">
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 3 NORMS OF CONDUCT FOR DMMMSU-SBO OFFICERS.</h3>
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-30">
        <div class="blog-slider__wrp swiper-wrapper">
          <!-- First Slide for the Second Slider -->
          <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__content">
              <div class="blog-slider__text">
                <h4>Every officer of the DMMMSU SBO shall observe the following standards of personal conduct in the discharge and execution of official duties:</h4>
                a) Commitment to students' interest. Officers shall uphold the common good of students over and above personal interest. All SBP resources and powers of respective offices of officers must be employed and used efficiently, effectively, honestly and economically to avoid wastage of SBO funds and revenues.
              </div>
            </div>
          </div>
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 4 DUTIES OF DMMMSU-SBO OFFICERS</h3>
      ...
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-31">
        <div class="blog-slider__wrp swiper-wrapper">
          <!-- First Slide for the Second Slider -->
          <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__content">
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 5 PENALTIES</h3>
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-32">
        <div class="blog-slider__wrp swiper-wrapper">
          <!-- First Slide for the Second Slider -->
          <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__content">
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 6 PROMULGATION OF RULES AND REGULATIONS, ADMINISTRATION AND ENFORCEMENT OF THIS CODE</h3>
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-33">
        <div class="blog-slider__wrp swiper-wrapper">
          <!-- First Slide for the Second Slider -->
          <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__content">
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 7 PRESIDING OFFICER DURING RECALL OR IMPEACHMENT PROCEEDINGS</h3>
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-34">
        <div class="blog-slider__wrp swiper-wrapper">
          <!-- First Slide for the Second Slider -->
          <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__content">
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 8 DISQUALIFICATION OF COMPLAINANT OR SPONSOR FROM TAKING THE RECALL OF IMPEACHMENT VOTE</h3>
      <!-- START SLIDE -->
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 9 SEPARABILITY CLAUSE</h3>
      <!-- START SLIDE -->
      <div class="blog-slider" id="blog-slider-35">
        <div class="blog-slider__wrp swiper-wrapper">
          <!-- First Slide for the Second Slider -->
          <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__content">
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 10 REPEALING CLAUSE</h3>
      <!-- START SLIDE -->
      ...
      <!-- END SLIDE -->
      <div class="space"></div>
      <h3 class="article">Sec. 11 EFFECTIVITY CLAUSE</h3>
      <!-- START SLIDE -->
