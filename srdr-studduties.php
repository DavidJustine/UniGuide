...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/student_rights_duties_nav_bar.css"/>
  ...
  <body>
    ...
    <div class="label-on-top">
      <h2>DUTIES AND RESPONSIBILITIES OF STUDENTS</h2>
      <p class="tcenter">In addition to those provided for under existing laws, every student shall:</p>
    </div>
    <div class="cards">
