...
<div class="timeline">
    <h2 id="h2-classreg">CLASSROOM REGULATIONS & MANAGEMENT<br><br></h2>
</div>
...
<br><br>Sec. 2 Faculty members shall not inflict corporal punishment on offending students.
</p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        <br><br>Sec. 2 For classes with departmental exams, questions for the midterm and final examinations shall be submitted to the Program Chair at least two weeks before the scheduled date of examination.
        </p>
        </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        <br><br>Sec. 4 A new set of questions must be prepared for a special midterm or final examination should this be needed.
        </p>
        </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        <br><br>Sec. 6 Faculty members shall strictly observe the limitation on co- curricular and extra-curricular activities as provided in the student handbook.
        </p>
        </div>
    </div>
  </div>
