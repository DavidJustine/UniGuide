...
<head>
    ...
    <title>UNIGUIDE| Classroom Regulations and Management</title>
...
<div class="mainc -with-mobile">
    ...
    <h2 id="h2-classreg">CLASSROOM REGULATIONS & MANAGEMENT</h2>
	</div>
	<div class="cards">
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					Sec. 2 Excuse slips for absences shall be obtained from the Office of the SAS Head upon the student's return. Excuses shall be for the class hours missed. Class work covered during the student's absences can be made up to the satisfaction of the faculty concerned within a reasonable period.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">
					Sec. 1 Faculty members shall be responsible for all student activities inside the classroom.<br/><br/>
					Sec. 2 Faculty members shall not inflict corporal punishment on offending students.
					</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Sec. 1 Class participation of students means their being present and attentive in class. When applicable, at least 10% of the final grade should be accorded to class participation.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">
					Sec. 1 Faculty members should evaluate students' performance objectively by constructing valid and reliable tests and examinations.<br/><br/>
					Sec. 2 For classes with departmental exams, questions for the midterm and final examinations shall be submitted to the Program Chair at least two weeks before the scheduled date of examination.
					</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					<h1 class="card__title">Evaluating Student Performance</h1>
					<p class="card__description">
					Sec. 3 All quizzes and tests should be returned promptly to the students after the test for immediate feedback.<br/><br/>
					Sec. 4 A new set of questions must be prepared for a special midterm or final examination should this be needed.
					</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					<h1 class="card__title">Evaluating Student Performance</h1>
					<p class="card__description">
					Sec. 5 Exemptions from taking the final examinations may be extended to deserving students with a tentative grade of 95 or better.<br/><br/>
					Sec. 6 Faculty members shall strictly observe the limitation on co- curricular and extra-curricular activities as provided in the student handbook.
					</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					<h1 class="card__title">Evaluating Student Performance</h1>
					<p class="card__description">Sec. 7 mandates instructors to spot students facing academic challenges (like midterm failures, absences, missing assignments), notify them of their status, empathize with those seeking help, advise on improvement, and offer consistent feedback.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
		...
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					<h1 class="card__title">Medium of Instruction</h1>
					<p class="card__description">Sec. 2 Faculty members shall express themselves fluently in English. Outside the classroom, faculty members are encouraged to maintain conversations in English, especially when talking to students.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Sec. 1 Departments share updated subject syllabi and learning plans with faculty before classes. Faculty working on the same subjects collaborate for content enhancement and reforms, guided by the course syllabus/learning plan.</p>
				</div>
			</div>
		</div>
	</div>
