...
<head>
    ...
    <title>UNIGUIDE| Withdrawal from the University</title>
...
<div class="mainc -with-mobile">
	<div class="label-on-top">
		<h2 id="h2-withuni">WITHDRAWAL FROM THE UNIVERSITY</h2>
	</div>
	<div class="cards">
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Any student wishing to officially withdraw from the university and transfer to another school, college or university should be cleared of all liabilities and responsibilities (administrative, academic and financial) in the University.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">The necessary documents for withdrawal such as clearance and request for honorable dismissal be availed of from the Office of the Registrar.</p>
				</div>
			</div>
		</div>
	</div>
