...
<head>
    ...
    <title>UNIGUIDE| Class Attendance</title>
...
<div class="timeline">
    <h2 id="h2-atten">CLASS ATTENDANCE<br><br></h2>
</div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        three (3) consecutive meetings or five (5) cumulative meetings, 
        the faculty concerned shall report the matter to the 
        Program Chair/Institute Directors, for formal notification of 
        the parent or guardian. The student shall then be referred to 
        the Head of Student Affairs and Services for follow-up.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        accommodation (solo parent, working students, PWDS, SPED) 
        is given a maximum of six (6) consecutive or cumulative absences.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        of the total number of hours required in the course before the mid-term 
        examination, shall be automatically dropped. If said absences is incurred 
        after the mid-term examination, with a passing mark in the class standing and
        due to valid reasons, the faculty may drop the student. However, when such absence
        is incurred after the midterm examination with a failing mark for class standing,
        the student shall be given a failing grade. Concerned students must be notified including their parents.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        to have a face to face meeting with his tutors at least once a month in a classroom
        setting. Two (2) consecutive unexcused absences on or before the midterm examination
        or failure to take the midterm examination means that the student is automatically
        dropped from the class. Concerned students must be notified.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        head upon the student's return. Excuses shall be for the class hours missed.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-index="0">
    <div class="card__inner">
      <div class="card__content">
        ...
        percent (80%) of a class time (face-to-face or online).
        </p>
      </div>
    </div>
  </div>
