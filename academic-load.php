...
<head>
    ...
    <title>UNIGUIDE| Academic Load</title>
...
<div class="mainc -with-mobile">
    ...
    <h2 id="h2-aclo">ACADEMIC LOAD</h2>
	</div>
	<div class="cards">
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Undergraduate<br/><br/>
					a. A student enrolled in a regular semester is limited to take the specified number of academic units in the curriculum he is enrolled in. On a meritorious case, an overload of not more than 3 units may be allowed.<br/><br/>
					b. A graduating student, on his last semester/term may be allowed to enroll up to 28 units academic load provided the student has no INC grade to his enrollment.
					</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Graduate Studies <br/><br/>A full graduate student could enroll a maximum of 15 units during the semester and 9 units in summer. Part time students with GPA of 95-97 could enroll 12 units and 9 units during the regular semester and summer, respectively.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">Undergraduate<br/><br/>Trainees for summer should have no other subject except OJT. During regular semester, graduating students may be allowed to enroll a maximum of 6 units only in addition to OJT.</p>
				</div>
			</div>
		</div>
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content" id="card-con">
					...
					<p class="card__description">DOUS<br/><br/>Students enrolled in the individualized or self-paced learning who have not completed the requirements of the course within five (5) months will be given a grade of incomplete.</p>
					</div>
			</div>
		</div>
	</div>
