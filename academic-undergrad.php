...
<head>
    ...
    <title>UNIGUIDE| Undergraduate Thesis</title>
...
<div class="mainc -with-mobile">
	<div class="label-on-top">
		<h2 id="h2-under">UNDERGRADUATE THESIS</h2>
	</div>
	<div class="cards">
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content">
					...
					<p class="card__description">Each student enrolled in thesis writing and is ready to defend his/her paper as recommended by the adviser will pay the amount of Php500.00 before the final oral examination for operational purposes.</p>
				</div>
			</div>
		</div>
		...
		<div class="card" data-index="0">
			<div class="card__inner">
				...
				<div class="card__content">
					...
					<p class="card__description">The thesis committee is composed of the following: Chairman (Specialist in the field), Adviser, Statistician, and a Technical Critic.</p>
				</div>
			</div>
		</div>
	</div>
